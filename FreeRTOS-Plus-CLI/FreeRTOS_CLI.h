...
#define config_MAX_OUTPUT_SIZE 2000
...
typedef void (*shellcmd_t)( char *chp, int argc, const char *argv[]);
...
typedef struct xCOMMAND_LINE_INPUT
{
    ...
    shellcmd_t pxCommandInterpreter;            /* A pointer to the callback function that will return the output generated by the command. */
